        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            <div className={styles.logoRow}>
              ...
              <span className={styles.logoText}>Room<span>ix</span></span>
            </div>
            ...
            <div className={styles.badges}>
              <a href="#download" className={styles.badge}>
          ...
          <div className={styles.col}>
            ...
            <Link href="/about">About Roomix</Link>
          ...
          <div className={styles.col}>
            ...
            <a href="mailto:support@roomix.in">support@roomix.in</a>
          </div>
        </div>

        <div className={styles.divider}/>
        <div className={styles.bottom}>
          <p>© {new Date().getFullYear()} Roomix. All rights reserved.</p>
